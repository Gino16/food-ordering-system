...
public class PaymentDomainServiceImpl implements PaymentDomainService {
  ...
  public PaymentEvent validateAndInitiatePayment(Payment payment, CreditEntry creditEntry,
    ...
    validCreditEntry(payment, creditEntry, failureMessages);
  ...
  private void validCreditEntry(Payment payment, CreditEntry creditEntry,
  ...
  private void validateCreditHistory(CreditEntry creditEntry, List<CreditHistory> creditHistories,
      List<String> failureMessages) {
    Money totalCreditHistory = getTotalHistory(creditHistories, TransactionType.CREDIT);
    Money totalDebitHistory = getTotalHistory(creditHistories, TransactionType.DEBIT);
  ...
  private Money getTotalHistory(List<CreditHistory> creditHistories,
      TransactionType transactionType) {

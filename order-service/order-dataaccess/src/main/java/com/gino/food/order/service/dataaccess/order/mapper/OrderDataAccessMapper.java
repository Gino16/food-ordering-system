package com.gino.food.order.service.dataaccess.order.mapper;
...
import com.gino.food.order.service.dataaccess.order.entity.OrderAddressEntity;
import com.gino.food.order.service.dataaccess.order.entity.OrderEntity;
import com.gino.food.order.service.dataaccess.order.entity.OrderItemEntity;
...
import com.gino.food.order.service.domain.valueobject.OrderItemId;
...
public class OrderDataAccessMapper {
  ...
  public Order orderEntityToOrder(OrderEntity orderEntity) {
    return Order.Builder
        .builder()
        .buildOrderId(new OrderId(orderEntity.getId()))

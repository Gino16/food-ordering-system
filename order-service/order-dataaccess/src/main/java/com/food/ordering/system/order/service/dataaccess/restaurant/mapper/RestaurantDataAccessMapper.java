...
public class RestaurantDataAccessMapper {
  ...
  public Restaurant restaurantEntityToRestaurant(List<RestaurantEntity> restaurantEntities) {
    ...
    List<Product> restaurantProducts =
        restaurantEntities.stream().map(restaurantEnt -> new Product(
                new ProductId(restaurantEnt.getProductId()),
                restaurantEnt.getProductName(),
                new Money(restaurantEnt.getProductPrice())))
            .toList();

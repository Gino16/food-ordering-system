package com.food.ordering.system.order.servide.domain.mapper;
...
import com.food.ordering.system.order.servide.domain.dto.create.OrderAddress;
...
public class OrderDataMapper {
  ...
  private List<OrderItem> orderItemsToOrderItemEntity(
      List<com.food.ordering.system.order.servide.domain.dto.create.OrderItem> items) {
    return items.stream()
